...
//setter uuendab igakord HTMLi
//nüüd tahan, et useffect läheks ka käima kui useState muutuja muutub setteri abiga
useEffect(() => {
  fetch("https://api.itbook.store/1.0/search/react?page=0" + leht)
